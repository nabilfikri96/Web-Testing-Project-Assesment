...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/input_Job Titles_btnAdd'))

WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input__jobTitlejobTitle'), 'test')

WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/textarea_Job Description_jobTitlejobDescription'), 'test')

WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/textarea_Note_jobTitlenote'), 'test')
