...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/input_Support Specialist_chkSelectRow'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/input_Job Titles_btnDelete'))
