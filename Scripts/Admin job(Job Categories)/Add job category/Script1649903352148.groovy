...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/input_Job Categories_btnAdd'))

WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input__jobCategoryname'), 'test1')
