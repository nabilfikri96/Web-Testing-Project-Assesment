...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/input_Technicians_chkSelectRow'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/input_Job Categories_btnDelete'))
