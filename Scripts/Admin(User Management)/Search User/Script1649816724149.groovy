...
WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Username_searchSystemUseruserName'), 'adash')

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/input_Status__search'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/input_Status__reset'))

WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Username_searchSystemUseruserName'), 'Fikri')
